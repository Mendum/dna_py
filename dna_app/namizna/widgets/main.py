...
class main(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.btn_normal_encoding = QPushButton('Normal')
        self.btn_normal_encoding.setFixedWidth(200)
        self.btn_normal_encoding.setFixedHeight(35)

        self.btn_compressed_encoding = QPushButton('Compressed')
        self.btn_compressed_encoding.setFixedWidth(200)
        self.btn_compressed_encoding.setFixedHeight(35)
        
        self.btn_file_encoding = QPushButton('Image')
        self.btn_file_encoding.setFixedWidth(200)
        self.btn_file_encoding.setFixedHeight(35)

        self.lb_hello = QLabel('Welcome to\ndna_py\n\nby Blaz Vidovic', self)
        self.lb_hello.setFixedWidth(610)
        ...
        self.btn_compressed_encoding.setStyleSheet(style.user_interface_btn_style)
        self.btn_file_encoding.setStyleSheet(style.user_interface_btn_style)

        grid_layout.addWidget(self.btn_normal_encoding, 0, 0)
        grid_layout.addWidget(self.btn_compressed_encoding, 0, 1)
